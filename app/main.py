...
if res is None:
    ...
    with cL:
        ...
        st.markdown(f"""<div class="custom-table" style="background-color: white; padding: 0; border-radius: 0px;
                    box-shadow: 0 2px 8px rgba(0,0,0,0.10); font-size: 1rem; margin-bottom: 16px;top-bottom: 4px;">
    ...
    with cR:
        ...
        st.markdown("""<style>.custom-table table { width: 100%; border-collapse: collapse; }
                    ...
                    unsafe_allow_html=True)
        st.markdown(f"""<div class="custom-table" style="background-color: white; padding: 0; border-radius: 0px;
                    box-shadow: 0 2px 8px rgba(0,0,0,0.10); font-size: 1rem; margin-bottom: 8px;top-bottom: 4px;">
